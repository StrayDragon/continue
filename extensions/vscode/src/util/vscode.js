...
function getViewColumnOfFile(uri) {
    var _a;
    for (var _i = 0, _b = vscode.window.tabGroups.all; _i < _b.length; _i++) {
        var tabGroup = _b[_i];
        for (var _c = 0, _d = tabGroup.tabs; _c < _d.length; _c++) {
            var tab = _d[_c];
            if (((_a = tab === null || tab === void 0 ? void 0 : tab.input) === null || _a === void 0 ? void 0 : _a.uri) &&
...
function getRightViewColumn() {
    ...
    for (var _i = 0, _a = vscode.window.tabGroups.all; _i < _a.length; _i++) {
        var tabGroup = _a[_i];
...
var showTextDocumentInProcess = false;
function openEditorAndRevealRange(uri, range, viewColumn, preview) {
    var _this = this;
    return new Promise(function (resolve, _) {
        vscode.workspace.openTextDocument(uri).then(function (doc) { return __awaiter(_this, void 0, void 0, function () {
            var err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!showTextDocumentInProcess) return [3 /*break*/, 3];
