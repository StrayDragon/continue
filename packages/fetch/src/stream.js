...
function streamResponse(response) {
    return __asyncGenerator(this, arguments, function streamResponse_1() {
        var _a, nodeMajorVersion, chunks, stream, _b, _c, _d, chunk, e_2_1, decoder, nodeStream, _e, _f, _g, chunk, e_3_1, e_4;
        ...
        return __generator(this, function (_p) {
            switch (_p.label) {
                ...
                case 1: return [2 /*return*/, _p.sent()]; // In case of client-side cancellation, just return
                case 2:
                    if (!(response.status !== 200)) return [3 /*break*/, 4];
                    _a = Error.bind;
                    return [4 /*yield*/, __await(response.text())];
                case 3: throw new (_a.apply(Error, [void 0, _p.sent()]))();
                case 4:
                    if (!response.body) {
                    ...
                    _p.label = 5;
                case 5:
                    _p.trys.push([5, 35, , 39]);
                    if (!(nodeMajorVersion >= 20)) return [3 /*break*/, 20];
                    stream = ReadableStream.from(response.body);
                    _p.label = 6;
                case 6:
                    _p.trys.push([6, 13, 14, 19]);
                ...
                case 21:
                    ...
                    _p.label = 22;
                case 22: return [4 /*yield*/, __await(_f.next())];
                case 23:
                    if (!(_g = _p.sent(), _l = _g.done, !_l)) return [3 /*break*/, 27];
                    _o = _g.value;
                    _e = false;
                    chunk = _o;
                    return [4 /*yield*/, __await(decoder.decode(chunk, { stream: true }))];
                case 24: return [4 /*yield*/, _p.sent()];
                case 25:
                    _p.sent();
                    chunks++;
                    _p.label = 26;
                ...
                case 29:
                    ...
                    if (!(!_e && !_l && (_m = _f.return))) return [3 /*break*/, 31];
                ...
                case 35:
                    e_4 = _p.sent();
                    if (!(e_4 instanceof Error)) return [3 /*break*/, 38];
                    if (!e_4.name.startsWith("AbortError")) return [3 /*break*/, 37];
                    return [4 /*yield*/, __await(void 0)];
                case 36: return [2 /*return*/, _p.sent()]; // In case of client-side cancellation, just return
                case 37:
                    if (e_4.message.toLowerCase().includes("premature close")) {
    ...
    try {
        ...
        if (data.error) {
            if (data.error &&
                ...
                throw new Error("Error streaming response: ".concat(data.error.message));
            }
            throw new Error("Error streaming response: ".concat(JSON.stringify(data.error)));
        }
        return data;
    }
    catch (e) {
...
function streamSse(response) {
    return __asyncGenerator(this, arguments, function streamSse_1() {
        var buffer, _a, _b, _c, value, position, line, _d, done, data, e_5_1, _e, done, data;
        var _f, e_5, _g, _h;
...
function streamJSON(response) {
    return __asyncGenerator(this, arguments, function streamJSON_1() {
        var buffer, _a, _b, _c, value, position, line, data, e_6, e_7_1;
        var _d, e_7, _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 8:
                    e_6 = _g.sent();
                    throw new Error("Malformed JSON sent from server: ".concat(line));
                case 9:
                    buffer = buffer.slice(position + 1);
                    return [3 /*break*/, 4];
                case 10:
