...
exports.convertOpenAIToolToGeminiFunction = convertOpenAIToolToGeminiFunction;
var jsonSchemaTypeToGeminiType = function (jsonSchemaType) {
...
function convertJsonSchemaToGeminiSchema(jsonSchema) {
    var jsonSchemaType = jsonSchema["type"];
    ...
    if (jsonSchema.properties) {
        ...
        for (var _i = 0, _a = Object.entries(jsonSchema.properties); _i < _a.length; _i++) {
...
function convertOpenAIToolToGeminiFunction(tool) {
    var _a;
    // Type guard for function tools
    if (tool.type !== "function" || !tool.function) {
        throw new Error("Unsupported tool type: ".concat(tool.type));
    }
    if (!tool.function.name) {
        throw new Error("Function name required");
    }
    var description = (_a = tool.function.description) !== null && _a !== void 0 ? _a : "";
