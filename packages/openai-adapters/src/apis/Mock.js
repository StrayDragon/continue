...
var MOCK_RESPONSE = "This is a mock response from the OpenAI API. It can be returned all at once or streamed chunk by chunk.";
var MockApi = /** @class */ (function () {
    function MockApi() {
    }
    MockApi.prototype.chatCompletionNonStream = function (body, signal) {
    ...
    MockApi.prototype.chatCompletionStream = function (body, signal) {
        return __asyncGenerator(this, arguments, function chatCompletionStream_1() {
            var lastMessage, content, chunks, _i, chunks_1, chunk;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        lastMessage = body.messages[body.messages.length - 1].content;
    ...
    MockApi.prototype.completionNonStream = function (body, signal) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, 800); })];
    ...
    MockApi.prototype.fimStream = function (body, signal) {
        return __asyncGenerator(this, arguments, function fimStream_1() {
            var chunks, _i, chunks_3, chunk;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        chunks = body.prompt.split(" ");
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(_i < chunks_3.length)) return [3 /*break*/, 6];
                        chunk = chunks_3[_i];
                        return [4 /*yield*/, __await(new Promise(function (resolve) { return setTimeout(resolve, 100); }))];
                    case 2:
                        _a.sent();
    ...
    MockApi.prototype.embed = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    MockApi.prototype.rerank = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    MockApi.prototype.list = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, [
                        {
