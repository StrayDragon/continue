...
exports.LlamastackApi = exports.Llamastack_API_BASE = void 0;
var fetch_1 = require("@continuedev/fetch");
var util_js_1 = require("../util.js");
var OpenAI_js_1 = require("./OpenAI.js");
exports.Llamastack_API_BASE = "http://localhost:8321/v1/openai/v1/";
var LlamastackApi = /** @class */ (function (_super) {
    __extends(LlamastackApi, _super);
    function LlamastackApi(config) {
        var _a, _b;
        return _super.call(this, __assign(__assign({}, config), { provider: "openai", apiBase: (_a = config.apiBase) !== null && _a !== void 0 ? _a : exports.Llamastack_API_BASE, apiKey: (_b = config.apiKey) !== null && _b !== void 0 ? _b : "dummy" })) || this;
    }
    LlamastackApi.prototype.fimStream = function (body, signal) {
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, __await((0, util_js_1.customFetch)(this.config.requestOptions)(endpoint, {
                                ...
                                headers: {
                                    ...
                                    "x-api-key": (_g = this.config.apiKey) !== null && _g !== void 0 ? _g : "",
    ...
    return LlamastackApi;
}(OpenAI_js_1.OpenAIApi));
exports.LlamastackApi = LlamastackApi;
