...
var MoonshotApi = /** @class */ (function (_super) {
    __extends(MoonshotApi, _super);
    function MoonshotApi(config) {
        var _this = _super.call(this, __assign(__assign({}, config), { provider: "openai" })) || this;
        _this.apiBase = "https://api.moonshot.cn/";
        return _this;
    }
    MoonshotApi.prototype.fimStream = function (body, signal) {
        return __asyncGenerator(this, arguments, function fimStream_1() {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        endpoint = new URL("v1/chat/completions", this.apiBase);
    ...
    MoonshotApi.prototype.list = function () {
