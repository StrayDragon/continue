...
exports.DeepSeekApi = exports.DEEPSEEK_API_BASE = void 0;
var fetch_1 = require("@continuedev/fetch");
var util_js_1 = require("../util.js");
var OpenAI_js_1 = require("./OpenAI.js");
exports.DEEPSEEK_API_BASE = "https://api.deepseek.com/";
var DeepSeekApi = /** @class */ (function (_super) {
    __extends(DeepSeekApi, _super);
    function DeepSeekApi(config) {
        var _a;
        return _super.call(this, __assign(__assign({}, config), { provider: "openai", apiBase: (_a = config.apiBase) !== null && _a !== void 0 ? _a : exports.DEEPSEEK_API_BASE })) || this;
    }
    DeepSeekApi.prototype.fimStream = function (body, signal) {
        return __asyncGenerator(this, arguments, function fimStream_1() {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        endpoint = new URL("beta/completions", this.apiBase);
    ...
    DeepSeekApi.prototype.list = function () {
