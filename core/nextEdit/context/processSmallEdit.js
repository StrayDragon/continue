...
var aggregateEdits_1 = require("./aggregateEdits");
var diffFormatting_1 = require("./diffFormatting");
var processNextEditData_1 = require("./processNextEditData");
var processSmallEdit = function (beforeAfterdiff, cursorPosBeforeEdit, cursorPosAfterPrevEdit, configHandler, getDefsFromLspFunction, ide) { return __awaiter(void 0, void 0, void 0, function () {
    var currentData;
    return __generator(this, function (_a) {
        currentData = aggregateEdits_1.EditAggregator.getInstance()
            .latestContextData || {
