...
var NCompass = /** @class */ (function (_super) {
    __extends(NCompass, _super);
    function NCompass() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    NCompass.prototype._convertModelName = function (model) {
        var _a;
        return (_a = NCompass.modelConversion[model]) !== null && _a !== void 0 ? _a : model;
    };
    NCompass.prototype._convertArgs = function (options, messages) {
    ...
    NCompass.prototype._getHeaders = function () {
        var headers = _super.prototype._getHeaders.call(this);
        headers["Accept"] = "text/event-stream";
        return headers;
    };
    NCompass.prototype._embed = function (chunks) {
        return __awaiter(this, void 0, void 0, function () {
            var resp, _a, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.fetch(NCompass.embeddingsApiEndpoint, {
                            method: "POST",
