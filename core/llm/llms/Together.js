...
var Together = /** @class */ (function (_super) {
    __extends(Together, _super);
    function Together() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Together.prototype._convertModelName = function (model) {
        return Together.MODEL_IDS[model] || this.model;
    };
    Together.prototype._streamComplete = function (prompt, signal, options) {
        return __asyncGenerator(this, arguments, function _streamComplete_1() {
            var _a, _b, _c, chunk, e_1_1;
            var _d, e_1, _e, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        _g.trys.push([0, 7, 8, 13]);
                        _a = true, _b = __asyncValues(this._legacystreamComplete(prompt, signal, options));
                        _g.label = 1;
