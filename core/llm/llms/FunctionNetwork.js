...
var FunctionNetwork = /** @class */ (function (_super) {
    __extends(FunctionNetwork, _super);
    function FunctionNetwork(options) {
        return _super.call(this, options) || this;
    }
    FunctionNetwork.prototype._convertModelName = function (model) {
        var _a;
        return (_a = FunctionNetwork.modelConversion[model]) !== null && _a !== void 0 ? _a : model;
    };
    FunctionNetwork.prototype.supportsFim = function () {
        return false;
    };
    FunctionNetwork.prototype.supportsCompletions = function () {
        return false;
    };
    FunctionNetwork.prototype.supportsPrefill = function () {
        return false;
    };
    FunctionNetwork.prototype._embed = function (chunks) {
        return __awaiter(this, void 0, void 0, function () {
            var resp, _a, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.fetch(new URL("embeddings", this.apiBase), {
                            method: "POST",
                            body: JSON.stringify({
                                input: chunks,
                                model: this.model,
