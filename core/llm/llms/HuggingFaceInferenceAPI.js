...
var HuggingFaceInferenceAPI = /** @class */ (function (_super) {
    __extends(HuggingFaceInferenceAPI, _super);
    function HuggingFaceInferenceAPI() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    HuggingFaceInferenceAPI.prototype._convertArgs = function (options) {
        var _a;
        return {
            max_new_tokens: (_a = options.maxTokens) !== null && _a !== void 0 ? _a : 1024,
            temperature: options.temperature,
            top_k: options.topK,
            top_p: options.topP,
        };
    };
    HuggingFaceInferenceAPI.prototype._streamComplete = function (prompt, signal, options) {
        return __asyncGenerator(this, arguments, function _streamComplete_1() {
            function stream() {
                return __asyncGenerator(this, arguments, function stream_1() {
                    var _a, _b, _c, chunk, text, e_2_1;
                    var _d, e_2, _e, _f;
                    var _g, _h;
                    return __generator(this, function (_j) {
                        switch (_j.label) {
                            ...
                            case 2:
                                if (!(_c = _j.sent(), _d = _c.done, !_d)) return [3 /*break*/, 9];
                                _f = _c.value;
                                _a = false;
                                chunk = _f;
                                text = (_h = (_g = chunk === null || chunk === void 0 ? void 0 : chunk.token) === null || _g === void 0 ? void 0 : _g.text) !== null && _h !== void 0 ? _h : "";
                                if (!text.endsWith("</s>")) return [3 /*break*/, 5];
                                return [4 /*yield*/, __await(text.slice(0, -5))];
                            case 3: return [4 /*yield*/, _j.sent()];
                            case 4:
                                _j.sent();
                                return [3 /*break*/, 8];
                            case 5: return [4 /*yield*/, __await(text)];
            ...
            var response, _a, _b, _c, text, e_1_1;
            var _d, e_1, _e, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __await(this.fetch(this.apiBase, {
                                headers: {
