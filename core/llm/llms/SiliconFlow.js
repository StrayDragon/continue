...
var SiliconFlow = /** @class */ (function (_super) {
    __extends(SiliconFlow, _super);
    function SiliconFlow() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.maxStopWords = 16;
        return _this;
    }
    SiliconFlow.prototype.supportsFim = function () {
        return true;
    };
    SiliconFlow.prototype._streamFim = function (prefix, suffix, signal, options) {
    ...
    SiliconFlow.prototype.rerank = function (query, chunks) {
        return __awaiter(this, void 0, void 0, function () {
            var endpoint, resp, _a, data, results;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.fetch(endpoint, {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                    Accept: "application/json",
