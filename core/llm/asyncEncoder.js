...
var LlamaAsyncEncoder = /** @class */ (function () {
    function LlamaAsyncEncoder() {
        this.workerPool = workerpool_1.default.pool(workerCodeFilePath("llamaTokenizerWorkerPool.mjs"));
    }
    LlamaAsyncEncoder.prototype.encode = function (text) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.workerPool.exec("encode", [text])];
            });
        });
    };
    LlamaAsyncEncoder.prototype.decode = function (tokens) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.workerPool.exec("decode", [tokens])];
            });
        });
    };
    // TODO: this should be called somewhere before exit or potentially with a shutdown hook
    LlamaAsyncEncoder.prototype.close = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.workerPool.terminate()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
var GPTAsyncEncoder = /** @class */ (function () {
    function GPTAsyncEncoder() {
        this.workerPool = workerpool_1.default.pool(workerCodeFilePath("tiktokenWorkerPool.mjs"));
    }
    GPTAsyncEncoder.prototype.encode = function (text) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.workerPool.exec("encode", [text])];
            });
    ...
    GPTAsyncEncoder.prototype.decode = function (tokens) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.workerPool.exec("decode", [tokens])];
            });
    ...
    // TODO: this should be called somewhere before exit or potentially with a shutdown hook
    GPTAsyncEncoder.prototype.close = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.workerPool.terminate()];
