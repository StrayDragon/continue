...
var chat_js_1 = require("./templates/chat.js");
var edit_js_1 = require("./templates/edit.js");
var PROVIDER_HANDLES_TEMPLATING = [
    "lmstudio",
    "lemonade",
    "openai",
    "nvidia",
...
function modelSupportsImages(provider, model, title, capabilities) {
    var _a;
    if ((capabilities === null || capabilities === void 0 ? void 0 : capabilities.uploadImage) !== undefined) {
    ...
    var lowerTitle = (_a = title === null || title === void 0 ? void 0 : title.toLowerCase()) !== null && _a !== void 0 ? _a : "";
    if (lowerModel.includes("vision") ||
        lowerTitle.includes("vision") ||
        MODEL_SUPPORTS_IMAGES.some(function (modelrx) { return modelrx.test(lowerModel) || modelrx.test(lowerTitle); })) {
        return true;
    }
    return false;
}
...
function modelSupportsNextEdit(capabilities, model, title) {
    if ((capabilities === null || capabilities === void 0 ? void 0 : capabilities.nextEdit) !== undefined) {
        return capabilities.nextEdit;
    }
    var lower = model.toLowerCase();
    if (MODEL_SUPPORTS_NEXT_EDIT.some(function (modelName) { return lower.includes(modelName) || (title === null || title === void 0 ? void 0 : title.includes(modelName)); })) {
        return true;
    }
    return false;
}
...
function autodetectTemplateFunction(model, provider, explicitTemplate) {
    if (explicitTemplate === void 0) { explicitTemplate = undefined; }
    if (explicitTemplate === undefined &&
        PROVIDER_HANDLES_TEMPLATING.includes(provider)) {
        return null;
    }
    var templateType = explicitTemplate !== null && explicitTemplate !== void 0 ? explicitTemplate : autodetectTemplateType(model);
    if (templateType) {
        var mapping = {
...
var USES_OS_MODELS_EDIT_PROMPT = [
    "alpaca",
    "chatml",
...
function autodetectPromptTemplates(model, explicitTemplate) {
    if (explicitTemplate === void 0) { explicitTemplate = undefined; }
    var templateType = explicitTemplate !== null && explicitTemplate !== void 0 ? explicitTemplate : autodetectTemplateType(model);
    var templates = {};
