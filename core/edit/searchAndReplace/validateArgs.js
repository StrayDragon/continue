...
function validateSearchAndReplaceFilepath(filepath, ide) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, ideUtils_1.resolveRelativePathInDir)(filepath, ide)];
                case 1:
                    resolvedFilepath = _a.sent();
                    if (!resolvedFilepath) {
                        throw new errors_1.ContinueError(errors_1.ContinueErrorReason.FileNotFound, "File ".concat(filepath, " does not exist"));
                    }
                    return [2 /*return*/, resolvedFilepath];
            }
        });
    });
}
