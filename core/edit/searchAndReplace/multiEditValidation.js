...
var findAndReplaceUtils_1 = require("./findAndReplaceUtils");
/**
...
function validateMultiEdit(args) {
    ...
    for (var i = 0; i < edits.length; i++) {
        ...
        if (i > 0 && edit.old_string === "") {
            throw new errors_1.ContinueError(errors_1.ContinueErrorReason.FindAndReplaceNonFirstEmptyOldString, "Edit at index ".concat(i, ": old_string cannot be empty. Only the first edit can have an empty old_string for insertion at the beginning of the file."));
        }
    }
    return { edits: edits };
}
