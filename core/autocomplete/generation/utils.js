...
function stopAfterMaxProcessingTime(stream, maxTimeMs, fullStop) {
    return __asyncGenerator(this, arguments, function stopAfterMaxProcessingTime_1() {
        var startTime, checkInterval, chunkCount, totalCharCount, _a, stream_1, stream_1_1, chunk, e_1_1;
        var _b, e_1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 5:
                    ...
                    if (!(chunkCount % checkInterval === 0)) return [3 /*break*/, 7];
                    if (!(Date.now() - startTime > maxTimeMs)) return [3 /*break*/, 7];
                    fullStop();
