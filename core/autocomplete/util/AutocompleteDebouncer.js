...
var AutocompleteDebouncer = /** @class */ (function () {
    function AutocompleteDebouncer() {
        this.debounceTimeout = undefined;
        this.currentRequestId = undefined;
    }
    AutocompleteDebouncer.prototype.delayAndShouldDebounce = function (debounceDelay) {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve) {
                        _this.debounceTimeout = setTimeout(function () {
                            ...
                            var shouldDebounce = _this.currentRequestId !== requestId;
